...
var sendEmailToCustomer = function (cab) {
  Email.send({
    ...
    html:
      ...
      ' <a href='+ getWebHost() +'>'+ displayWebHostText +'</a>' +
...
var displayWebHostText = displayHost.startsWith("www.")
  ? displayHost
  : "www." + displayHost;
...
Accounts.emailTemplates.enrollAccount.html = function (user, url) {
  return (
    ...
    "P.O. Box 1566 | Grapevine, TX 76099<br>" +
    "p 817.949.2030 x112 | f 817.488.9158<br>" +
    '<a href="mailto:sbachhuber@eklunds.com">sbachhuber@eklunds.com</a> | <a href='+ getWebHost() +'>'+ displayWebHostText +'</a><br><br>' +
  ...
  if (re !== null) {
    ...
    cabs.forEach(function (cab) {
      ...
      if (customer) {
        ...
        ws.Cell(j, 21).Link(
          getWebHost() + "/uploads/cabpdfs/" + cab.renderedFile + ".pdf"
        );
        j++;
      }
    });
